...
model = load_model("C:/Users/prakh/Desktop/AiCricketScoreBoard/Code/CNN_model.h5")

gestures = {
  1:'out', # the key 'out' is mapped to the integer value 1.
    2:'noball', # the key 'noball' is mapped to the integer value 2.
   3:'timeout',
   4: 'bye',
    5:'six'
