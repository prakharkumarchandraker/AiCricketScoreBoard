...
def predict(gesture):
    img = cv2.cvtColor(gesture, cv2.COLOR_GRAY2BGR)
...
while True:
    if frame is not None:
        ...
        if flag and status == '1' and ustatus == 'umpire':
